...
def load_and_preprocess_data(filepath):
    ...
    joblib.dump(le, "/Users/kartikey0104/Desktop/faltu/genai/location_encoder.pkl")
...
def predict_demand(hour, day_of_week, month, is_weekend, temp, battery_cap, location):
    model = load_model("/Users/kartikey0104/Desktop/faltu/genai/ev_demand_model.pkl")
    le = joblib.load("/Users/kartikey0104/Desktop/faltu/genai/location_encoder.pkl")
...
if __name__ == "__main__":
    filepath = "/Users/kartikey0104/Desktop/faltu/genai/ev_charging_patterns.csv"
    if os.path.exists(filepath):
        ...
        save_model(model, "/Users/kartikey0104/Desktop/faltu/genai/ev_demand_model.pkl")
